...
```
git clone https://github.com/Immersive-Backend-Resource/Fundamental-Programming-Week1.git
```

setelah clone selesai, jalankan perintah `cd Fundamental-Programming-Week1` -->  **HAL INI DILAKUKAN 1x saja**
...
buat repository pada github organization kalian dengan format: `Fundamental-Programming-Week1`
